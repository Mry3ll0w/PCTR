  ...
  extends Thread
{
	...
	private static volatile long Turno = 1;
	private static volatile long nVueltas = 10000;
    ...
    {
      switch(tipoHilo){
        case 1:{for(int i=0; i<nVueltas; i++)n++;break;}//Seccion critica ya que comparten la n
