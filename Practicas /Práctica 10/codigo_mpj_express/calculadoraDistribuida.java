//calculadora distribuida cutre...
//COMPILAR: javac -cp .;%MPJ_HOME%/lib/mpj.jar calculadoraDistribuida.java
//EJECUTAR: mpjrun.bat -np 5 calculadoraDistribuida

import mpi.*;
public class calculadoraDistribuida {
