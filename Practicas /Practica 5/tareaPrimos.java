...
public class tareaPrimos implements Callable<Long>{
  ...
  //Long no es igual que long, Long es una API de Java un wrapper de long "normal"
  //Runnable y Callable son capsulas que engloban codigo concurrente que no es capaz 
